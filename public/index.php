...
<div class="container mb-5 pt-3">
    <div class="d-flex justify-content-between align-items-end mb-4">
        ...
        <a href="../views/tours.php" class="text-decoration-none fw-bold" style="color: var(--primary-color);">Xem tất
                ...
                <div class="tour-item">
                    <div class="card tour-card">
                        ...
                        <div class="card-body-custom">
                            ...
                            <h5 class="tour-title" title="<?= htmlspecialchars($tour['tour_name']) ?>">
                                <?= htmlspecialchars($tour['tour_name']) ?></h5>
                            <p class="tour-price"><?= number_format($tour['price']) ?> <span
                                    style="font-size: 0.9rem; font-weight: 500; color: #6c757d;">VNĐ</span></p>

                            <a href="../views/tour_detail.php?id=<?= $tour['tour_id'] ?>"
