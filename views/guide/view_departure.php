<?php 
// Tính toán tiến độ điểm danh
$totalPax = 0;
$checkedInPax = 0;
foreach ($bookings as $b) {
    $totalPax += $b['number_of_people'];
    if ($b['status'] == 'checked_in') {
        $checkedInPax += $b['number_of_people'];
    }
}
...
<style>
    ...
    /* --- TOP STATS CARDS (Nổi lên trên ảnh) --- */
    ...
    .ui-box { 
        ...
        margin-bottom: 25px; height: fit-content; /* Ôm sát nội dung, không dãn bậy */
    }
    ...
    /* --- DANH SÁCH KHÁCH HÀNG (Cột Phải) --- */
    .pax-grid { 
        display: grid; 
        grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); /* Tự động chia cột thông minh */
        gap: 15px; 
    }
    .pax-card { 
...
<div class="hero-banner" style="background-image: url('<?= $imgUrl ?>');">
    <div class="hero-overlay">
        ...
        <div class="hero-meta">
            ...
            <span><i class="bi bi-calendar-event"></i> <?= !empty($departure['start_date']) ? date('d/m/Y', strtotime($departure['start_date'])) : '--' ?> - <?= !empty($departure['end_date']) ? date('d/m/Y', strtotime($departure['end_date'])) : '--' ?></span>
        </div>
    </div>
</div>
        ...
        <div class="col-xl-4 col-lg-5">
            ...
            <div class="ui-box">
                ...
                <div class="service-tag">
                    ...
                    <div>
                        <strong class="text-success d-block mb-1">Bao gồm</strong>
                ...
                <div class="service-tag mt-4">
                    ...
                    <div>
                        <strong class="text-danger d-block mb-1">Không bao gồm</strong>
                        ...
                        <?php foreach ($bookings as $b): ?>
                            <div class="pax-card">
                                ...
                                <div class="pax-action mt-3">
                                    ...
                                    <?php else: ?>
                                        <div class="status-checked"><i class="bi bi-check-circle-fill"></i> Đã có mặt</div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endforeach; ?>
